-- UK Frontier Technology Policy Tracker — schema (v2 base + proposed extensions)
--
-- This is a design reference, not yet applied to any database. It reproduces
-- v2 (docs/reference/uk-frontier-tech-data-schema-v2.md) verbatim and adds the
-- three extensions described in docs/DESIGN.md: `people` / `record_people`,
-- `sector_taxonomy_xref`, and `v_policy_signal_by_category`.
--
